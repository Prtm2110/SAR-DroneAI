...
const MetricCard = ({ icon: Icon, title, value, trend }) => (
  <Card>
    <CardContent>
      ...
      {trend && (
        <Typography variant="body2" color={trend > 0 ? green[500] : red[500]}>
          {trend > 0 ? "+" : ""}
          {trend}% from last episode
        </Typography>
      )}
    </CardContent>
  </Card>
      ...
      <Box height={350}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            <XAxis dataKey="step" stroke={grey[400]} />
      ...
      >
        ...
        {data.drones.some((d) => d.status === "Warning") && (
          <Alert severity="error" sx={{ mb: 3 }}>
            ...
            One or more drones reporting warning status. Check individual drone
            statuses below.
          </Alert>
        )}
